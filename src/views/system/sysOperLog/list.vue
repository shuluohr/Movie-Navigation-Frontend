<template>
  <div class="app-container">
        ...
        <el-row>
          <el-col :span="8">
            <el-form-item label="关 键 字">
              <el-input style="width: 95%" v-model="searchObj.keyword" placeholder="操作用户"></el-input>
            </el-form-item>
          </el-col>
          <el-col :span="8">
    ...
    <el-table
      ...
      <el-table-column prop="operName" label="账号" width="180"/>
      <el-table-column prop="operIp" label="ip地址" width="110"/>
      <el-table-column prop="method" label="操作方法" width="400"/>
...
import api from '@/api/operLog/operLog'
    ...
    fetchData(page = 1) {
      ...
      api.getOperLogPageInfo(this.page, this.limit, this.searchObj).then(
        response => {
          ...
          console.log("回调:", response.data.records)
